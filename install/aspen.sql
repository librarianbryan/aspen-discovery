...
CREATE TABLE `admin_property_search_entries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS administration_record_lock;
CREATE TABLE `administration_record_lock` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `module` (`module`,`toolName`,`recordId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
DROP TABLE IF EXISTS aspen_event_settings;
CREATE TABLE `aspen_event_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS aspen_lida_home_screen_link;
CREATE TABLE `aspen_lida_home_screen_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS aspen_lida_home_screen_link_group;
CREATE TABLE `aspen_lida_home_screen_link_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS aspen_lida_home_screen_link_group_entry;
CREATE TABLE `aspen_lida_home_screen_link_group_entry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS aspen_lida_home_screen_link_group_users;
CREATE TABLE `aspen_lida_home_screen_link_group_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `homeScreenLinkGroupId` int(11) DEFAULT NULL,
  `userId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `aspen_sites` (
  ...
  `sendSlackAlerts` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
...
CREATE TABLE `author_authority` (
  ...
  KEY `id_normalized` (`id`,`normalized`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `author_authority_alternative` (
  ...
  KEY `normalized_id` (`normalized`,`authorId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS bds_settings;
CREATE TABLE `bds_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` tinytext DEFAULT 'default',
  `dbmCode` varchar(250) DEFAULT NULL,
...
DROP TABLE IF EXISTS calendar_display_setting_library;
CREATE TABLE `calendar_display_setting_library` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `calendarDisplaySettingId` int(11) NOT NULL,
...
CREATE TABLE `calendar_display_settings` (
  ...
  `fullMonthName` tinyint(4) NOT NULL DEFAULT 0,
  `calendarTitle` varchar(255) DEFAULT 'Events Calendar',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `ce_user_campaign` (
  ...
  `staffCampaignCompleteEmailSent` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cloud_library_settings` (
  ...
  `name` varchar(100) DEFAULT '',
  `reindexOnSunday` tinyint(1) DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS cloudsource_setting;
CREATE TABLE `cloudsource_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `bypassAspenCloudSourcePage` tinyint(1) DEFAULT 0,
  `patronUrl` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `event` (
  ...
  `hideTimestamps` tinyint(1) NOT NULL DEFAULT 0,
  `displayEventBranchOnThumbnail` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS event_field_calendar_options;
CREATE TABLE `event_field_calendar_options` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `calendarDisplaySettingId` int(11) NOT NULL,
  `eventFieldId` int(11) NOT NULL,
  `weight` int(11) DEFAULT 0,
...
CREATE TABLE `event_type` (
  ...
  `includeInReports` tinyint(4) DEFAULT 1,
  `displayEventBranchOnThumbnail` tinyint(1) DEFAULT 0,
  `displayEventBranchOnThumbnailCustomizable` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS explore_more_source;
CREATE TABLE `explore_more_source` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `source` varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS explore_more_source_entry;
CREATE TABLE `explore_more_source_entry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exploreMoreSourceGroupId` int(11) NOT NULL,
  `exploreMoreSourceId` int(11) NOT NULL,
  `weight` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `exploreMoreSourceGroupId` (`exploreMoreSourceGroupId`),
  KEY `exploreMoreSourceId` (`exploreMoreSourceId`),
  CONSTRAINT `explore_more_source_entry_ibfk_1` FOREIGN KEY (`exploreMoreSourceGroupId`) REFERENCES `explore_more_source_group` (`id`) ON DELETE CASCADE,
  CONSTRAINT `explore_more_source_entry_ibfk_2` FOREIGN KEY (`exploreMoreSourceId`) REFERENCES `explore_more_source` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS explore_more_source_group;
CREATE TABLE `explore_more_source_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS explore_more_source_library;
CREATE TABLE `explore_more_source_library` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exploreMoreSourceId` int(11) NOT NULL,
  `libraryId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `exploreMoreSourceId` (`exploreMoreSourceId`,`libraryId`),
  CONSTRAINT `explore_more_source_library_ibfk_1` FOREIGN KEY (`exploreMoreSourceId`) REFERENCES `explore_more_source` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS explore_more_source_location;
CREATE TABLE `explore_more_source_location` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exploreMoreSourceId` int(11) NOT NULL,
  `locationId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `exploreMoreSourceId` (`exploreMoreSourceId`,`locationId`),
  CONSTRAINT `explore_more_source_location_ibfk_1` FOREIGN KEY (`exploreMoreSourceId`) REFERENCES `explore_more_source` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS gale_product_codes;
...
DROP TABLE IF EXISTS gale_settings;
...
DROP TABLE IF EXISTS gale_usage;
...
CREATE TABLE `google_api_settings` (
  ...
  `googleTranslateKey` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `grouped_work_alternate_titles` (
  ...
  KEY `alternateInfo` (`alternateTitle`,`alternateAuthor`,`alternateGroupingCategory`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `grouped_work_display_settings` (
  ...
  `eContentSortingGroupId` int(11) DEFAULT 1,
  `showCopiesForPeriodicalsWithNoItems` tinyint(1) DEFAULT 0,
  `hideManifestationsInMobileView` tinyint(1) DEFAULT 1,
  `showItemBarcodes` tinyint(1) DEFAULT 0,
  `showIndexedSeriesWithNoveList` tinyint(1) DEFAULT 0,
  `numSeriesToShowBeforeMore` int(11) DEFAULT 3,
  `hideIndexedEContentSeries` tinyint(1) DEFAULT 0,
  `includeEContentInShelvingLocations` tinyint(1) DEFAULT 1,
  `whereIsItDisplayStyle` tinyint(1) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS grouped_work_econtent_sort;
CREATE TABLE `grouped_work_econtent_sort` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `eContentSortingGroupId` int(11) NOT NULL,
  `eContentSource` varchar(255) NOT NULL,
  `weight` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `eContentSortingGroupId` (`eContentSortingGroupId`,`eContentSource`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS grouped_work_econtent_sort_group;
CREATE TABLE `grouped_work_econtent_sort_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE `grouped_work_facet` (
  ...
  `canLock` tinyint(4) DEFAULT 0,
  `displayNamePlural` varchar(50) DEFAULT NULL,
  `numTotalEntriesToShowInMore` int(11) NOT NULL DEFAULT 30,
  PRIMARY KEY (`id`),
  UNIQUE KEY `groupFacet` (`facetGroupId`,`facetName`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `grouped_work_record_items` (
  ...
  KEY `idx_callNumberId` (`callNumberId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `grouped_work_records` (
  ...
  KEY `idx_publicationDateId` (`publicationDateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS hero_slider_location;
CREATE TABLE `hero_slider_location` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  ...
  KEY `libraryId` (`libraryId`),
  CONSTRAINT `hero_slider_location_ibfk_1` FOREIGN KEY (`playlistId`) REFERENCES `hero_slider_playlist` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS hero_slider_playlist;
CREATE TABLE `hero_slider_playlist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `libraryId` int(11) DEFAULT -1,
  `deleted` tinyint(1) DEFAULT 0,
...
DROP TABLE IF EXISTS hero_slider_playlist_image;
CREATE TABLE `hero_slider_playlist_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `playlistId` (`playlistId`),
  KEY `imageId` (`imageId`),
  CONSTRAINT `hero_slider_playlist_image_ibfk_1` FOREIGN KEY (`playlistId`) REFERENCES `hero_slider_playlist` (`id`) ON DELETE CASCADE,
  CONSTRAINT `hero_slider_playlist_image_ibfk_2` FOREIGN KEY (`imageId`) REFERENCES `image_uploads` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `holiday` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `LocationDate` (`locationId`,`date`),
  KEY `Library` (`libraryId`),
  KEY `Date` (`date`),
  KEY `LibraryDate` (`libraryId`,`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hoopla_settings` (
  ...
  `recordExtractionBatchSize` int(11) DEFAULT 500,
  `indexingTime` int(11) DEFAULT 1,
  `hooplaFlexBatchSize` int(3) DEFAULT 50,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `image_uploads` (
  ...
  `dateDeleted` int(11) DEFAULT 0,
  `deletedBy` int(11) DEFAULT NULL,
  `aspectRatioWidth` int(11) DEFAULT NULL,
  `aspectRatioHeight` int(11) DEFAULT NULL,
  `calculatedAspectRatio` decimal(10,6) DEFAULT NULL,
  `altText` varchar(512) DEFAULT NULL,
  `pageLink` varchar(512) DEFAULT NULL,
  `startDate` int(11) DEFAULT 0,
  `endDate` int(11) DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `type` (`type`,`title`),
  KEY `aspectRatio` (`aspectRatioWidth`,`aspectRatioHeight`),
...
DROP TABLE IF EXISTS indexed_duration;
CREATE TABLE `indexed_duration` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `indexing_profiles` (
  ...
  `index896asSeries` tinyint(1) DEFAULT 1,
  `index897asSeries` tinyint(1) DEFAULT 1,
  `index898asSeries` tinyint(1) DEFAULT 1,
  `index899asSeries` tinyint(1) DEFAULT 1,
  `displayTitleStripRegex` text DEFAULT NULL,
  `use650ForPictureBooks` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ip_lookup` (
  ...
  `bypassFailedLoginChecks` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `ip_range` (`startIpVal`,`endIpVal`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `library` (
  ...
  `showShareOnX` tinyint(4) DEFAULT 1,
  ...
  `showShareOnFacebook` tinyint(4) DEFAULT 1,
  `showShareOnPinterest` tinyint(4) DEFAULT 1,
  `showShareOnLink` tinyint(4) DEFAULT 1,
  `AspenPWASettingId` int(11) DEFAULT -1,
  `pay360SettingId` int(11) NOT NULL DEFAULT -1,
  `galeSettingsId` int(11) DEFAULT -1,
  `displayExploreMoreBarInGale` tinyint(1) DEFAULT 1,
  `allowEventRegistration` tinyint(1) NOT NULL DEFAULT 0,
  `holdPromptForEditions` tinyint(4) DEFAULT 0,
  `enableThirdPartySMSNotifications` tinyint(1) DEFAULT 0,
  `enableSearchInterpreter` tinyint(4) DEFAULT 0,
  `aspenEventsToInclude` int(11) DEFAULT 0,
  `hidePickupLocationPrompt` tinyint(1) DEFAULT 0,
  `allowChangingPickupLocationForUnavailableHolds` tinyint(1) DEFAULT 1,
  `showWebsiteSearch` tinyint(4) DEFAULT 1,
  `messageBeeSettingId` int(11) DEFAULT -1,
  `loralSettingId` int(11) DEFAULT -1,
  `bdsSettingId` int(11) DEFAULT -1,
  `hideSoftDeleteListUI` tinyint(1) DEFAULT 0,
  `displayCallNumberInCheckoutHistory` tinyint(1) DEFAULT 0,
  `displayVolumeInCheckoutHistory` tinyint(1) DEFAULT 0,
  `showHoldsReadyForPickupSection` tinyint(4) DEFAULT 1,
  `phoneField` char(1) DEFAULT 't',
  `workPhoneField` char(1) DEFAULT 'p',
  `showCancelledHolds` tinyint(1) DEFAULT 1,
  `sierraAddressLineForCityState` tinyint(1) DEFAULT 2,
  `sierraZipOnSameLineAsCityState` tinyint(1) DEFAULT 1,
  `lidaHomeScreenLinkGroupId` int(11) DEFAULT -1,
  `locationsToExcludeAvailabilityFor` varchar(255) NOT NULL DEFAULT '',
  `includeRemoteCheckoutsInMaxLocalIllRequests` tinyint(1) DEFAULT 1,
  `eventsDefaultCalendarView` tinyint(1) NOT NULL DEFAULT 0,
  `allowHoldsToBeGrouped` tinyint(1) DEFAULT 0,
...
DROP TABLE IF EXISTS library_cloudsource_setting;
CREATE TABLE `library_cloudsource_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `libraryId` int(11) DEFAULT NULL,
  `cloudsourceSettingId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS library_google_analytics;
CREATE TABLE `library_google_analytics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `libraryId` int(11) NOT NULL,
  `googleApiSettingId` int(11) NOT NULL,
  `googleAnalyticsTrackingId` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `libraryId` (`libraryId`,`googleApiSettingId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
DROP TABLE IF EXISTS library_user_defined_field;
CREATE TABLE `library_user_defined_field` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `libraryId` int(11) NOT NULL,
...
DROP TABLE IF EXISTS library_user_list_facet_setting;
CREATE TABLE `library_user_list_facet_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `libraryId` int(11) NOT NULL,
  `userListFacetGroupId` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `library_web_builder_custom_form` (
  ...
  `emailResultsTo` varchar(250) DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `libraryId` (`libraryId`),
  KEY `formId` (`formId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `location` (
  ...
  `pay360SettingId` int(11) NOT NULL DEFAULT -1,
  `displayExploreMoreBarInGale` tinyint(1) DEFAULT 1,
  `useLocationNameForMaps` tinyint(1) DEFAULT 0,
  `lidaHomeScreenLinkGroupId` int(11) DEFAULT -1,
  `locationsToExcludeAvailabilityFor` varchar(255) NOT NULL DEFAULT '',
  `showInHolidayHoursTable` tinyint(1) NOT NULL DEFAULT 1,
...
DROP TABLE IF EXISTS location_cloudsource_setting;
CREATE TABLE `location_cloudsource_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `locationId` int(11) DEFAULT NULL,
  `cloudsourceSettingId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS loral_settings;
CREATE TABLE `loral_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `loralUrl` varchar(255) DEFAULT NULL,
  `loralId` varchar(10) DEFAULT NULL,
...
DROP TABLE IF EXISTS manually_grouped_work_records;
CREATE TABLE `manually_grouped_work_records` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `manually_grouped_work_id` int(11) NOT NULL,
  `type` varchar(50) NOT NULL,
  `identifier` varchar(150) NOT NULL,
  `user_provided_identifier` varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT `manually_grouped_work_records_work_id` FOREIGN KEY (`manually_grouped_work_id`) REFERENCES `manually_grouped_works` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS manually_grouped_works;
CREATE TABLE `manually_grouped_works` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `grouped_work_permanent_id` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `title` (`title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `materials_request` (
  ...
  `materialsRequestTitleId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `status` (`status`),
  KEY `status_2` (`status`),
...
DROP TABLE IF EXISTS materials_request_title;
CREATE TABLE `materials_request_title` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `author` varchar(255) DEFAULT NULL,
  `format` varchar(25) DEFAULT NULL,
  `formatId` int(10) DEFAULT NULL,
  `isbn` varchar(15) DEFAULT NULL,
  `upc` varchar(15) DEFAULT NULL,
  `issn` varchar(8) DEFAULT NULL,
  `comments` varchar(255) DEFAULT NULL,
  `hasExistingRecord` tinyint(1) DEFAULT NULL,
  `lastCheckForExistingRecord` int(11) DEFAULT NULL,
  `existingRecordUrl` tinytext DEFAULT NULL,
  `dateFirstRequested` int(11) DEFAULT NULL,
  `dateLastRequested` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS message_bee_settings;
CREATE TABLE `message_bee_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
CREATE TABLE `nyt_api_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `booksApiKey` varchar(48) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS overdrive_qr_sessions;
CREATE TABLE `overdrive_qr_sessions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `settingId` int(11) NOT NULL,
...
CREATE TABLE `overdrive_scopes` (
  ...
  `suppressKindleFormat` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `overdrive_settings` (
  ...
  `deletionCheckHour` int(11) DEFAULT 8,
  `enableQRCodeAuth` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `palace_project_settings` (
  ...
  `requirePin` tinyint(1) DEFAULT 1,
  `showPalaceProjectLinks` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
CREATE TABLE `palace_project_title` (
  ...
  KEY `responseIndex` (`palaceProjectId`,`rawChecksum`,`rawResponseLength`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `palace_project_title_availability` (
  ...
  KEY `collectionStats` (`collectionId`,`deleted`,`needsHold`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS pay360_setting;
CREATE TABLE `pay360_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `wsdlUrl` varchar(255) DEFAULT NULL,
  `privateKey` varchar(255) NOT NULL,
  `scpId` varchar(50) DEFAULT NULL,
  `hmacKeyId` varchar(50) DEFAULT NULL,
...
DROP TABLE IF EXISTS placard_usage;
CREATE TABLE `placard_usage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `instance` varchar(100) DEFAULT NULL,
  `year` int(11) DEFAULT NULL,
  `month` int(11) DEFAULT NULL,
  `placardName` varchar(255) DEFAULT NULL,
  `pageViews` int(11) DEFAULT 0,
  `pageViewsByAuthenticatedUsers` int(11) DEFAULT 0,
  `pageViewsInLibrary` int(11) DEFAULT 0,
  `timesShown` int(11) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `placard_usage_unique` (`instance`,`year`,`month`,`placardName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `plugin` (
  ...
  `minAspenVersion` varchar(20) DEFAULT NULL COMMENT 'Minimum required Aspen Discovery version',
  PRIMARY KEY (`id`),
  KEY `idx_plugin_slug` (`name`,`enabled`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS prioritized_shelf_locations;
CREATE TABLE `prioritized_shelf_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `groupedWorkSettingsId` int(11) NOT NULL,
  `shelfLocation` varchar(250) DEFAULT '',
  `weight` int(11) DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `groupedWorkSettingsId` (`groupedWorkSettingsId`,`weight`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS record_grouping_overrides;
CREATE TABLE `record_grouping_overrides` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `source` varchar(50) NOT NULL,
...
CREATE TABLE `role_permissions` (
  ...
  KEY `roleId` (`roleId`)
) ENGINE=InnoDB AUTO_INCREMENT=1239 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `role_permissions` WRITE;
/*!40000 ALTER TABLE `role_permissions` DISABLE KEYS */;
INSERT INTO `role_permissions` VALUES (124,1,2),(123,1,3),(130,1,85),(1203,1,225),(1143,2,1),(1145,2,4),(1147,2,5),(1148,2,6),(1140,2,7),(1141,2,8),(1142,2,9),(1150,2,10),(1151,2,12),(1105,2,14),(1107,2,16),(1108,2,19),(1109,2,20),(1110,2,21),(1111,2,22),(1103,2,26),(1093,2,27),(1094,2,28),(1046,2,29),(1047,2,30),(1048,2,31),(1050,2,32),(1051,2,33),(1052,2,34),(1053,2,35),(1054,2,36),(1055,2,37),(1056,2,38),(1057,2,39),(1060,2,41),(1061,2,42),(1062,2,43),(1063,2,44),(1064,2,45),(1065,2,46),(1066,2,47),(1067,2,49),(1088,2,50),(1089,2,52),(1095,2,54),(1096,2,56),(1097,2,58),(1098,2,60),(1152,2,61),(1153,2,62),(1154,2,63),(1104,2,70),(1084,2,71),(1167,2,72),(1087,2,76),(1155,2,77),(1158,2,78),(1102,2,79),(1156,2,86),(1071,2,91),(1100,2,92),(1149,2,94),(1159,2,95),(1160,2,97),(1161,2,99),(1162,2,101),(1163,2,103),(1164,2,105),(1165,2,107),(1166,2,108),(1101,2,109),(1146,2,111),(1157,2,113),(1113,2,115),(1114,2,116),(1115,2,117),(1116,2,118),(1117,2,119),(1118,2,120),(1119,2,121),(1120,2,122),(1121,2,123),(1122,2,124),(1123,2,125),(1124,2,126),(1125,2,127),(1127,2,129),(1129,2,130),(1130,2,131),(1131,2,132),(1128,2,133),(1132,2,134),(1133,2,135),(1134,2,136),(1135,2,137),(1136,2,138),(1137,2,139),(1138,2,140),(1139,2,141),(1076,2,142),(1077,2,144),(1078,2,145),(1074,2,146),(1079,2,148),(1072,2,149),(1075,2,150),(1073,2,151),(1112,2,152),(1045,2,153),(1068,2,154),(1085,2,158),(1099,2,159),(1080,2,160),(1049,2,161),(1091,2,162),(1090,2,163),(1092,2,164),(1043,2,166),(1081,2,167),(1059,2,168),(1044,2,169),(1144,2,170),(1106,2,175),(1082,2,176),(1086,2,177),(1083,2,178),(1069,2,179),(1070,2,180),(1168,2,181),(1169,2,182),(1170,2,184),(1171,2,187),(1172,2,188),(1173,2,189),(1174,2,190),(1176,2,192),(1177,2,193),(1178,2,194),(1179,2,195),(1183,2,199),(1184,2,200),(1185,2,201),(1186,2,203),(1187,2,204),(1188,2,205),(1189,2,206),(1190,2,207),(1191,2,208),(1194,2,210),(1195,2,211),(1196,2,212),(1197,2,215),(1198,2,217),(1199,2,218),(1200,2,220),(1201,2,222),(1202,2,223),(1204,2,226),(1205,2,227),(1206,2,228),(1207,2,231),(1208,2,234),(1209,2,236),(1210,2,237),(1211,2,238),(1218,2,241),(1217,2,242),(1219,2,243),(1220,2,247),(1221,2,252),(1222,2,260),(1223,2,261),(1224,2,262),(1225,2,263),(1226,2,265),(1227,2,266),(1228,2,267),(1229,2,268),(1230,2,269),(1231,2,270),(1232,2,272),(1233,2,275),(1234,2,276),(1235,2,277),(1236,2,278),(1237,2,286),(1238,2,288),(5,3,76),(474,6,11),(475,6,13),(445,6,15),(446,6,17),(448,6,22),(436,6,41),(437,6,51),(438,6,53),(439,6,55),(440,6,57),(441,6,59),(476,6,63),(477,6,77),(478,6,78),(443,6,81),(444,6,82),(442,6,110),(449,6,116),(450,6,117),(451,6,118),(452,6,119),(453,6,120),(454,6,121),(455,6,122),(456,6,123),(457,6,124),(458,6,125),(459,6,126),(460,6,127),(462,6,129),(464,6,130),(465,6,131),(466,6,132),(463,6,133),(467,6,135),(468,6,136),(469,6,137),(470,6,138),(471,6,139),(472,6,140),(473,6,141),(1181,6,197),(1182,6,198),(1,7,55),(2,7,57),(3,7,59),(4,7,63),(31,8,23),(30,8,24),(33,8,25),(154,9,88),(156,9,90),(504,10,15),(505,10,17),(506,10,22),(498,10,46),(499,10,55),(500,10,57),(516,10,63),(502,10,93),(503,10,110),(507,10,117),(508,10,122),(509,10,123),(511,10,132),(510,10,133),(512,10,136),(513,10,138),(514,10,139),(515,10,140),(501,10,147),(36,11,18),(39,11,22),(37,11,55),(38,11,57),(343,11,136),(344,11,139),(345,11,140),(35,13,77),(284,13,113),(119,31,27),(120,31,28),(117,32,8),(113,32,9),(108,32,29),(109,32,30),(107,32,31),(110,32,32),(111,32,33),(112,32,34),(106,32,35),(115,32,36),(116,32,37),(102,32,38),(104,32,39),(105,32,62),(283,32,113),(131,36,80),(128,37,81),(129,38,83),(168,39,95),(169,39,97),(170,39,99),(171,39,101),(172,39,103),(173,39,105),(174,39,107),(175,39,108),(1192,39,208),(1212,39,238),(176,40,96),(177,40,98),(178,40,100),(179,40,102),(180,40,104),(181,40,106),(182,40,107),(1193,40,209),(1213,40,239);
...
CREATE TABLE `search_interpreter_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `processFormatCategories` tinyint(4) DEFAULT 1,
  `formatCategoriesToSkip` tinytext DEFAULT NULL,
  `processFormats` tinyint(4) DEFAULT 1,
  `formatsToSkip` tinytext DEFAULT NULL,
  `processPluralFormats` tinyint(4) DEFAULT 1,
  `pluralFormatsToSkip` tinytext DEFAULT NULL,
  `processAudiences` tinyint(4) DEFAULT 1,
  `audiencesToSkip` tinytext DEFAULT NULL,
  `processPluralAudiences` tinyint(4) DEFAULT 1,
  `pluralAudiencesToSkip` tinytext DEFAULT NULL,
  `processFictionNonFiction` tinyint(4) DEFAULT 1,
  `processNew` tinyint(4) DEFAULT 1,
  `processAvailable` tinyint(4) DEFAULT 1,
  `triggerSeriesSearch` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS search_interpreter_special_terms;
CREATE TABLE `search_interpreter_special_terms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `settingId` int(11) NOT NULL,
  `term` tinytext NOT NULL,
  `combineWithNewFilter` tinyint(4) DEFAULT 1,
  `facetsToApply` text DEFAULT NULL,
  `sortToApply` varchar(50) DEFAULT NULL,
  `weight` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS search_interpreter_terms_to_skip;
CREATE TABLE `search_interpreter_terms_to_skip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `settingId` int(11) NOT NULL,
...
CREATE TABLE `self_check_completion_message` (
  ...
  `owningLocations` varchar(500) DEFAULT '.*',
  `checkoutLocations` varchar(500) DEFAULT '.*',
  `requireConfirmation` tinyint(4) DEFAULT 0,
...
CREATE TABLE `self_reg_municipality_values_sierra` (
  ...
  `extendExpirationToMonthEnd` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `self_registration_form_sierra` (
  ...
  `noCommaInAddress` tinyint(1) DEFAULT 0,
  `cityDropdown` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `series` (
  ...
  `dateUpdated` int(11) DEFAULT NULL,
  `created` int(11) DEFAULT NULL,
  `sortMethod` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE `series_member` (
  ...
  `deleted` tinyint(1) DEFAULT 0,
  `priorityScore` int(11) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE `session` (
  ...
  KEY `remember_me_last` (`remember_me`,`last_used`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `system_variables` (
  ...
  `spellcheckMaxCollationTries` int(11) DEFAULT 25,
  ...
  `monitorWaitTime` tinyint(1) DEFAULT 1,
  `hooplaVersion` int(11) DEFAULT 1,
  `numPalaceProjectIndexingThreads` int(11) DEFAULT 1,
  `nightlyIndexTrigger` text DEFAULT NULL,
  `titleSearchBehavior` int(11) DEFAULT 1,
  `customGroupedWorkSearchSpecs` text DEFAULT NULL COMMENT 'Path to custom grouped work search specs YAML file',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `themes` (
  ...
  `isDarkColorScheme` tinyint(1) DEFAULT 0,
  `showButtonShimmer` tinyint(1) DEFAULT 1,
  `deleted` tinyint(1) DEFAULT 0,
  `dateDeleted` int(11) DEFAULT 0,
  `deletedBy` int(11) DEFAULT NULL,
  `focusColor` char(7) DEFAULT '#3174AF',
  `focusColorDefault` tinyint(1) DEFAULT 1,
  `focusBorderWidth` varchar(6) DEFAULT NULL,
  `generatedRTLCss` longtext DEFAULT NULL,
  `successButtonBackgroundColor` char(7) DEFAULT '#5cb85c',
  `successButtonBackgroundColorDefault` tinyint(1) DEFAULT 1,
  `successButtonForegroundColor` char(7) DEFAULT '#000000',
  ...
  `successButtonHoverForegroundColor` char(7) DEFAULT '#000000',
...
CREATE TABLE `translations` (
  ...
  `googleTranslated` tinyint(4) DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  ...
  `rememberHoldPromptForEdition` tinyint(4) DEFAULT 0,
  `lastListGroupViewed` int(11) DEFAULT NULL,
  `lastListGroupAdded` int(11) DEFAULT NULL,
  `showHoldHelpMessages` tinyint(4) DEFAULT 1,
  `notifySavedSearches` tinyint(1) NOT NULL DEFAULT 0,
  `allowAppRequestLogging` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_account_summary` (
  ...
  `dataIsStale` tinyint(1) DEFAULT 1,
  `holdsAreStale` tinyint(1) DEFAULT 1,
  `checkoutsAreStale` tinyint(1) DEFAULT 1,
  `holdCacheTime` int(11) DEFAULT 0,
  `checkoutCacheTime` int(11) DEFAULT 0,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS user_app_request_log;
CREATE TABLE `user_app_request_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
...
CREATE TABLE `user_aspen_event_instance_registrations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `eventInstanceId` int(11) NOT NULL,
...
CREATE TABLE `user_checkout` (
  ...
  `isLocalILL` tinyint(1) DEFAULT 0,
  `showPalaceProjectLink` tinyint(4) DEFAULT 0,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS user_gale_usage;
...
CREATE TABLE `user_hold` (
  ...
  `isLocalILL` tinyint(1) DEFAULT 0,
  `holdGroupId` int(11) DEFAULT NULL,
  `visualHoldGroupId` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`,`source`,`recordId`),
  KEY `userId_2` (`userId`,`groupedWorkId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user_list` (
  ...
  `listGroupId` int(11) DEFAULT -1,
  `customAuthorName` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `dateUpdated` (`dateUpdated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS user_list_facet;
...
DROP TABLE IF EXISTS user_list_facet_groups;
...
DROP TABLE IF EXISTS user_list_group;
...
CREATE TABLE `user_notification_tokens` (
  ...
  `tokenType` varchar(16) DEFAULT 'expo',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user_page_defaults` (
  ...
  `userListFilters` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_payments` (
  ...
  `pay360TransactionStateMessage` varchar(255) DEFAULT NULL,
  `pay360Timestamp` varchar(14) DEFAULT NULL,
  `stripeReceiptUrl` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_reading_history_work` (
  ...
  `editedCheckInDate` bigint(20) DEFAULT NULL,
  `deleted` tinyint(4) NOT NULL DEFAULT 0,
  `isIll` tinyint(1) DEFAULT 0,
  ...
  KEY `groupedWork_userId` (`groupedWorkPermanentId`,`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='The reading history for patrons';
DROP TABLE IF EXISTS user_removed_campaigns;
CREATE TABLE `user_removed_campaigns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `campaignId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_work_review` (
  ...
  KEY `groupedWork_userId` (`groupedRecordPermanentId`,`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `web_builder_resource_usage` (
  ...
  `pageViewsInLibrary` int(11) DEFAULT 0,
  `instance` varchar(100) DEFAULT NULL,
  `pageViewsFromPlacard` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `instance` (`instance`,`year`,`month`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO grouped_work_facet (id, facetGroupId, displayName, facetName, weight, numEntriesToShowByDefault, showAsDropDown,sortMode,showAboveResults,showInResults,showInAdvancedSearch,collapseByDefault,useMoreFacetPopup,translate,multiSelect,canLock,displayNamePlural) VALUES 
